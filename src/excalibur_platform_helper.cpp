internal void
platform_process_digital_button(digital_button_t *button, b32 down) {
...
internal void
platform_process_analog_button(analog_button_t *button, f32 value) {
    button->value = value;
    b32 was_down = button->down;
...
internal void
platform_process_stick(stick_t *stick, f32 x, f32 y) {
